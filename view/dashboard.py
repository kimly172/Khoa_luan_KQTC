...
def setup_dashboard(Ma_Cty):
    ...
    with col1:    
        ve_bieu_do_duong(df_cal, "Khả năng thanh toán hiện thời & nhanh",
                     ["Khả năng thanh toán hiện thời", "Khả năng thanh toán nhanh"], y_label=' lần')
    with col2:  
        kha_nang_chi_tra_bang_tien(df_cal)  

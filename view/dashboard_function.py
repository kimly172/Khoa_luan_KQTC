...
def ve_bieu_do(df, title, chi_tieu_con):
    ...
    fig.update_layout(
        ...
        plot_bgcolor='white',
        legend=dict(title="", x=0.5, y=1.15, orientation='h', xanchor='center', font=dict(size=10)), # Chuẩn hóa vị trí legend
...
def ve_bieu_do_duong(df, title, chi_tieu_con, hover_labels=None, y_format='.2f', y_suffix='%'):
    ...
    fig.update_layout(
        ...
        plot_bgcolor='white',
        legend=dict(x=0.5, y=1.15, orientation='h', xanchor='center', font=dict(size=10)), # Chuẩn hóa layout
...
def ROA_bieu_do_Dupont(df_total):
    ...
    fig.update_layout(
        ...
        plot_bgcolor='white',
        legend=dict(x=0.5, y=1.15, orientation='h', xanchor='center', font=dict(size=10)), # Chuẩn hóa legend
